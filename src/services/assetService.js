...
// Get company prefix for serial number
const getCompanyPrefix = (companyName) => {
  ...
  return prefixes[companyName] || "GEN";
};

// Generate unique random serial number with format: PREFIX-DDMMYYYY-XXX
export const generateSerialNumber = (companyName = "OmTrans") => {
  ...
  const random = String(Math.floor(Math.random() * 900) + 100); // 3-digit random (100-999)
